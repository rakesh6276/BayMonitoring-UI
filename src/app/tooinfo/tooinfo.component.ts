...
setInterval(()=>{
  this.clock = Date.now();
   ...
   sendIdGetToolPage(id){
    this._service.sendIdGetToolPage(id).subscribe(data=>{
      ...
      console.log('too55',this._toolImage);
  ...
  sendIdGetImage(){
    console.log('ID FOR IMAGE',this.toolIdGeneral);
    console.log('TOOL IMAGE TO BACKEND',this.toolPicture);
    let formObj = new FormData();
    console.log('FORMOBJ',formObj);
    formObj.append('image',this.toolPicture);
    formObj.append('id',this.toolIdGeneral);
